...
county_pop <- fread(paste0(data_dir, "processed/pop/dex/dex_county_pop00_21.csv"))
state_pop <- fread(paste0(data_dir, "processed/pop/dex/dex_state_pop00_21.csv")) %>% mutate(postal_code = state_code)
